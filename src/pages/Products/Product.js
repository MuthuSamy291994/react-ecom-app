...
import { addtocard, addtofavitem } from "../../Feature/Action/Action";
import "./Product.css";
...
const Product = () => {
  ...
  return (
    <div className="container">
      {isloading ? (
        <CircularProgress className="loadicon"></CircularProgress>
      ) : (
        <>
              ...
              <div className="card" key={i}>
                <div className="card1">
                  ...
                  <div className="cardbody">
                    ...
                    <IconButton
                      onClick={() => addfavor(item)}
                      style={
                        state.favItem.some((fav) => fav.id === item.id)
                          ? { color: "red" }
                          : { color: "#000" }
                      }
                    >
